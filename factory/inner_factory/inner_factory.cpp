...
class Point 
{
	...
	public:
		...
		class PointFactory {
			private:
				PointFactory() {} // avoid the user to create a (useless) instance of the point factory
...
int main()
{
	Point myPoint1 = Point::PointFactory::NewCartesian(5, 6);
	Point myPoint2 = Point::PointFactory::NewPolar(2, M_PI/2);
